...
1. **Case Tester**: בדיקה של תוצאות הרצת קוד התלמיד (Output/Return Value) בהשוואה לפתרון המורה.
2. **Code Tester**: בדיקה של תחביר ומבנה הקוד (האם הפונקציה רקורסיבית? האם היא סטטית? האם יש לולאות מקוננות?).
3. **AI Tester**: (בפיתוח) בדיקת קוד באמצעות מודל בינה מלאכותית.
